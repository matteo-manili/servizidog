<%@ include file="/common/taglibs.jsp"%>
  ...
  <head>
	...
	<script src="<c:url value="/scripts/annunci.js"/>" type="text/javascript"></script>
...
$(document).ready(function(){
  ...
  FJS_Servizi.addCallback('afterAddRecords', function(){
  ...
  FJS_Servizi.setStreaming({
	    data_url: 'scripts/annunci.json',
	    stream_after: 1,
	    batch_size: 50
	  });
...
<div class="container">
  ...
  <div class="sidebar col-md-3">
    ...
    <div>
      <h4 class='col-md-6'>Movies (<span id="total_Servizi">0</span>)</h4>
