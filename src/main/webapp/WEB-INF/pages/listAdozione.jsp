<%@ include file="/common/taglibs.jsp"%>
  ...
  <head>
	<title><fmt:message key="adozione.lista"/></title>
    <meta name="breadcrumb" content="<fmt:message key="adozione.lista"/>"/>
    <meta name="description" content="<fmt:message key="meta.description.adozioneList"/>" />
...
var serviziTot = ${AdozioneTot};
var serviziJson = ${AdozioneJson};
...
<div class="container">
  ...
  <div class="sidebar col-md-3">
    <div>
      <legend align="left"><fmt:message key="adozione.adozionecane.title"/></legend>
