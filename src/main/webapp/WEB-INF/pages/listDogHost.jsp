<%@ include file="/common/taglibs.jsp"%>
  ...
  <head>
	<title><fmt:message key="doghost.lista"/></title>
    <meta name="breadcrumb" content="<fmt:message key="doghost.lista"/>"/>
    <meta name="description" content="<fmt:message key="meta.description.dogHostList"/>" />
...
var serviziTot = ${DogHostTot};
var serviziJson = ${DogHostJson};
...
<div class="container">
  ...
  <div class="sidebar col-md-3">
    <div>
      <legend align="left"><fmt:message key="doghost.title"/></legend>
    ...
    <div class="well">
      <fieldset id="tariffa_criteria_Servizi">
        <legend><fmt:message key="doghost.tariffagiornaliera"/></legend><span id="tariffa_range_label_Servizi" class="slider-label">0 - 40 &#8364;</span>
