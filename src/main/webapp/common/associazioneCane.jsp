...
<form:form action="associazioneCaneform" commandName="caneListContainer" modelAttribute="caneListContainer" method="post" id="caneListForm" >
	<br>
     <table>
       	...
       	$(document).ready(function () {
	        ...
	        $("#linkRemove a").click(function() {
	        	...
	        	//alert("inizio idCane= "+idCane);
	    			$.ajax({
	   				  type: 'POST',
	   				  url: '${pageContext.request.contextPath}/eliminaCaneAssociazione?idCane='+idCane,
