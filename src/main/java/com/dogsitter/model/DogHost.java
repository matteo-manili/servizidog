...
@Entity
@Table(name = "dog_host")
public class DogHost extends BaseObject implements Serializable {
	private static final long serialVersionUID = 1170979122657455194L;
	...
	private String metriQuadrati;
	private boolean terrazza;
	private boolean giardino;
	private boolean animaliPresenti;
	...
	public DogHost(final String titolo) {
        this.titolo = titolo;
    }
	...
	@Column(name = "metri_quadrati")
	public String getMetriQuadrati() {
		return metriQuadrati;
	}

	public void setMetriQuadrati(String metriQuadrati) {
	...
	@Column(name = "animali_presenti", columnDefinition = "boolean default false")
	public boolean isAnimaliPresenti() {
		return animaliPresenti;
	}

	public void setAnimaliPresenti(boolean animaliPresenti) {
