...
public interface UserManager extends GenericManager<User, Long> {
	...
	User startConfirm(User user, Locale locale, String AppUrl) throws MailException, Exception;
	
	User confirmSignup(String token) throws UserSignupTokenNotFoundException, Exception ;
    ...
    void sendUsenameAndPasswrdRecoveryEmail(String username, String urlTemplate);
	...
	User getUserFacebookByEmail(String email);
