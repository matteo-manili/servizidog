...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.dogsitter.service.impl.PasswordTokenManager#generateRecoveryToken(com.dogsitter.model.User)
     */
    @Override
    ...
    /**
     * @see com.dogsitter.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.dogsitter.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.dogsitter.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
