...
public class UserCounterListener implements ServletContextListener, HttpSessionAttributeListener, HttpSessionListener {
    ...
    public synchronized void contextInitialized(ServletContextEvent sce) {
    	...
    	System.out.println("sono in UserCounterListner contextInitialized");
    ...
    synchronized void removeUsername(User user) {
        ...
        servletContext.setAttribute(Constants.RUOLI_SERVIZI_UTENTE, null);
     ...
     *
     * Questo metodo è stato progettato per catturare login quando dell'utente e registrare il proprio nome
     * ora lo utilizzo anche per inizializzare il menu.
     *
    ...
    public void attributeAdded(HttpSessionBindingEvent event) {
        if (event.getName().equals(EVENT_KEY) && !isAnonymous()) {
            ...
            if (securityContext != null && securityContext.getAuthentication().getPrincipal() instanceof User) {
                ...
                //aggiungo attributo per visualizzare all'utente il menu di gestione servizi ruoli
                System.out.println("servletContext.setAttribute MENU SERVIZI");
                servletContext.setAttribute(Constants.RUOLI_SERVIZI_UTENTE, user.getTipoRuoliServiceDogListPerMenu());
