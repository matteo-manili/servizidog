package com.dogsitter.webapp.listener;
...
public class StartupListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        System.out.println("sono in StartupListener contextInitialized...");
    ...
    public static void setupContext(ServletContext context) {
        ...
        InizializzaServiziDogManager inizializzaServiziDog = (InizializzaServiziDogManager) ctx.getBean("inizializzaServiziDogManager");
        
        //CreaSitemapManager creaSitemapManager = (CreaSitemapManager) ctx.getBean("creaSitemapManager");
        
        // get list of possible roles
        context.setAttribute(Constants.AVAILABLE_ROLES, mgr.getAllRoles());
        log.debug("Drop-down roles initialization complete [OK]");
        
        // get list of ruoli servizi dog (non lo uso più)
        //context.setAttribute(Constants.AVAILABLE_ROLES_SERVIZIDOG, mgr.getAllRuoliServiziDog());
        //log.debug("Drop-down ruoli servizi dog initialization complete [OK]");
          
        try {
        	//SPOSTATO IN 
        	//Creazione cartella /tmpImage e /tmpImageAnnunci e caricamento immagini annunci in cartella
        	log.debug("Creazione cartella /tmpImage e /tmpImageAnnunci...");
			inizializzaServiziDog.creaCartelleImmagini(context);
			
			//creo la Sitemap.xml
	        //log.debug("creazione Sitemap.xml...");
	        //creaSitemapManager.creaSitemapProUrlProfili(context);
