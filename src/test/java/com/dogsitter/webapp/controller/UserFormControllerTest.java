...
public class UserFormControllerTest extends BaseControllerTestCase {
    ...
    public void testAdd() throws Exception {
        ...
        HttpSession session = mockMvc.perform(post("/j_security_check")
            ...
            .andExpect(redirectedUrl("/home-utente"))
            .andReturn()
            .getRequest()
            .getSession();

        mockMvc.perform((get("/admin/userformAdmin").session((MockHttpSession) session))
            .param("method", "Add"))
    ...
    public void testCancel() throws Exception {
        ...
        mockMvc.perform((post("/admin/userformAdmin")
            .param("cancel", "")))
            .andExpect(redirectedUrl("/home-utente"));
    }
    ...
    public void testEdit() throws Exception {
        ...
        mockMvc.perform((get("/admin/userformAdmin").session((MockHttpSession) session)
            .param("id", "1")))
            .andExpect(model().attributeExists("user"))
            .andExpect(model().attribute("user", hasProperty("fullName", is("Simona Rossi"))));
    }
    ...
    public void testAddWithMissingFields() throws Exception {
        mockMvc.perform((post("/admin/userformAdmin").param("firstName", "Jack")))
            .andExpect(status().isOk())
    ...
    public void testRemove() throws Exception {
        ...
        session = mockMvc.perform((post("/admin/userformAdmin"))
            .session((MockHttpSession) session)
