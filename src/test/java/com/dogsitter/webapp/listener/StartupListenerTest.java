...
public class StartupListenerTest {
    ...
    public void testContextInitialized()  {
        ...
        /*
        assertNotNull(sc.getAttribute(Constants.STORAGE_DIRECTORY_IMMAGINI));
        assertNotNull(sc.getAttribute(Constants.STORAGE_DIRECTORY_IMMAGINI_ANNUNCI));
        
        String storageDirectory = null;
		String storageDirectorympImageAnnunci = null;
        
        assertNotNull( storageDirectory );
        assertNotNull( storageDirectorympImageAnnunci );
        
		
		
        assertNotNull( theDir );
        assertNotNull( theDirImgAnnunci );
        */
    }
}
