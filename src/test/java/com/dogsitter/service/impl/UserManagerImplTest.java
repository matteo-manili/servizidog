...
public class UserManagerImplTest extends BaseManagerMockTestCase {
    ...
    public void testGetUser() throws Exception {
    	...
    	System.out.println("SONO IN testGetUser");
    ...
    public void testSaveUser() throws Exception {
    	...
    	System.out.println("SONO IN testSaveUser");
    ...
    public void testAddAndRemoveUser() throws Exception {
    	...
    	System.out.println("SONO IN testAddAndRemoveUser");
        ...
        //matteo
        TipoRuoliServiceDog roleTipo = new TipoRuoliServiceDog(Constants.DOGSITTER_ROLE);
        user.addtipoRuoli(roleTipo);
    ...
    public void testUserExistsException() {
    	...
    	System.out.println("SONO IN testUserExistsException");
